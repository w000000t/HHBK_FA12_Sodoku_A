/*
Funktionsname: navigation.c
Gegebene Parameter: char keypressed[]
zurückgegebener Wert: char keypressed[]
Beschreibung: Überschreibt den chararray(keypressed) mit 
up, down, left, right, return, escape, enter in Großbuchstaben.
*/
